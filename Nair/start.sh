...
conky -c $HOME/.config/conky/Nair/NairM.conf &> /dev/null &
conky -c $HOME/.config/conky/Nair/NairL.conf &> /dev/null &
conky -c $HOME/.config/conky/Nair/NairR.conf &> /dev/null &
